// RFC 5322 General Email Regex (emailregex.com)
// https://emailregex.com/
//
// IP 옥텟 버그 수정 (Stack Overflow 권장):
// emailregex.com의 `[01]?[0-9][0-9]?` 패턴은 `00` 같은 불법 옥텟을 허용한다.
// https://stackoverflow.com/questions/201323/what-is-the-best-regular-expression-for-validating-email-addresses
const IP_OCTET = '(2(5[0-5]|[0-4][0-9])|1[0-9][0-9]|[1-9]?[0-9])';
const IP_ADDRESS = `(?:(?:${IP_OCTET})\\.){3}(?:${IP_OCTET})`;
